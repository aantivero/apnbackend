...
/**
 * Performance test for the TransferenciaApp entity.
 */
class TransferenciaAppGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the TransferenciaApp entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all transferenciaApps")
            .get("/api/transferencia-apps")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created transferenciaApp")
                .get("${new_transferenciaApp_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created transferenciaApp")
            .delete("${new_transferenciaApp_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
